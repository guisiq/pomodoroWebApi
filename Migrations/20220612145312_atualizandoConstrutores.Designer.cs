...
namespace pomodoro.Migrations
{
    ...
    [Migration("20220612145312_atualizandoConstrutores")]
    partial class atualizandoConstrutores
    {
            ...
            modelBuilder.Entity("pomodoro.data.Tarefa", b =>
                {
                    ...
                    b.Property<long?>("RotinaTarefaId")
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("pomodoro.data.Tarefa", b =>
                {
                    ...
                    b.HasOne("pomodoro.data.Rotina", null)
                        .WithMany("Tarefas")
                        .HasForeignKey("RotinaTarefaId");
